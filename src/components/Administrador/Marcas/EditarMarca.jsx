...
export default function EditarMarca({ marca, onCancel, onSuccess }) {
  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-white rounded shadow-md">
        ...
        <div className="w-32 h-32 border border-dashed border-gray-400 rounded-md flex items-center justify-center bg-gray-50 mb-4 overflow-hidden relative">
          {imagenRecortada ? (
            <>
              ...
              <button
                type="button"
                onClick={handleEliminarRecortada} // <-- usa el reset dentro
      ...
      <CropperModal
        ...
        onClose={() => {
          setImagenOriginal(null);
          resetFileInput(); // <-- NUEVO: cerrar sin recortar también libera
        }}
